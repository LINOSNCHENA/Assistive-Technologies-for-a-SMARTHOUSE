...
#==============================================================================================#0
numpy.random.seed(3)
dataset = numpy.loadtxt("indianData.csv", delimiter=",")
X = dataset[:,0:8]
Y = dataset[:,8]
...
plt.title('Training and Testing accuracy in indian-Port1 detection')
...
plt.title('Training and testing loss in indian-Port2 detection')
...
plt.title('Training and testing mean_squared_error in Indian-port2 detection')
